...
@section('content')
<div class="container">
    <form action="/BazaWiedzy/bazawiedzystore" enctype="multipart/form-data" method="post">
    @csrf
    ...
    extraPlugins: [ SimpleUploadAdapterPlugin ],
             ...
             <div class="row pt-4 pb-5">
                <button class="btn btn-dark">Dodoaj nową bazę wiedzy</button>
             </div>
